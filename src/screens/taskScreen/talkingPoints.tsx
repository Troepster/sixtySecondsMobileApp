  ...
  return (
    <View style={{flex: 1, backgroundColor: '#E1EEFE'}}>
      <ScrollView style={{overflow: 'visible'}}>
        <ScrollView>
          <View
            style={{paddingHorizontal: 30, paddingTop: 50, paddingBottom: 300}}>
            <List.Accordion
              ...
              {allowSalesSteps ? (
                    ...
                    return (
                      <React.Fragment key={salesStep}>
                        <TouchableOpacity
                          ...
                          onPress={() => showUsTheModal(salesStep)}>
                          <Text
                            style={{
                            ...
                            {salesBehaviour[salesStep as SalesSteps].longTitle}
                          </Text>
                          <MaterialIcons
                            color="#243F68"
                            name="info-outline"
                        ...
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            setScript({...script, [salesStep]: text})
                          }
                        />
                      </React.Fragment>
                    );
                ...
                <React.Fragment>
                  <TouchableOpacity
                    ...
                    onPress={() => showUsTheModal(SalesSteps.GENERAL)}>
                    <Text
                      style={{
                        fontFamily: fonts.PoppinsRegular,
                        color: '#536278',
                      ...
                      {salesBehaviour[SalesSteps.GENERAL].longTitle}
                    </Text>
                    <MaterialIcons
                      color="#243F68"
                      name="info-outline"
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setScript({...script, [SalesSteps.GENERAL]: text})
                    }
                  />
                </React.Fragment>
              )}
