    ...
    <>
      ...
      <View style={{flex: 1,backgroundColor: '#e1eefe'}}>
        ...
        <SafeAreaView style={{flex: 1}}>
            <View style={{marginHorizontal: 30, backgroundColor: '#e1eefe'}}>
              ...
              <View style={{marginTop: 35, flexDirection: 'row', flex: 1, alignItems: 'center'}}>
                <View style={{height: 1, backgroundColor: '#CCD9F6', flex: 1}} />
                <View style={{height: 20, paddingHorizontal: 5, justifyContent: 'center'}}><Text style={{fontFamily: 'Roboto-Regular', color: '#3068B3'}}>OR</Text></View>
                <View style={{height: 1, backgroundColor: '#CCD9F6', flex: 1}} />
              </View>
              <View style={{flexDirection: 'row', height: 60, marginTop: 70}}>
